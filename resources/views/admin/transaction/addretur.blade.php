            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h1 class="m-0">
                                <a href="{{URL('admin/master_retur_transaksi')}}">Retur Transaction</a>
                                / Add
                            </h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                ...
                <div class="container-fluid">
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Add New Retur</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <div class="card-body">
...
<form id="formadd" action="{{URL('admin/transaction/add_retur')}}" method="POST">
    @csrf
...
<script>
    ...
    function pochange() {
        ...
        $.get(`/api/get_detail_transaction/${idpo}`, function(data) {
            console.log('dat', data);

            $("#transaction_date").val(data.payload.header.created_date);
            $("#supplier_name").val(data.payload.header.customer);
    ...
    function submit() {
        ...
        console.log('l', $("#purchaseorder").val());
