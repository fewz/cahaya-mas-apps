            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <h1 class="m-0">
                                <a href="{{URL('admin/master_supplier')}}">Retur Transaksi</a>
                                / View
                            </h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type='text' disabled value="{{$data[0]->customer}}" class="form-control" />
                            </div>
                        </div>
                    </div>
...
<form id="form2" action="{{URL('admin/transaction/update_retur')}}" method="POST">
    ...
    <input type="hidden" class="form-control required" value="{{$dt->id_h_transaction}}" name="id_h">
</form>
