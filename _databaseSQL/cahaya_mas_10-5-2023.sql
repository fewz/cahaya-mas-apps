...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 05, 2023 at 04:51 PM
...
(1, 'AE0001', 'ADRIEL EDGARD', '085232654598', 'JL.TERNATE NO. 40, MAKASSAR', 'gold', 150),
...
INSERT INTO `h_transaction` (`id`, `order_number`, `created_date`, `finish_date`, `id_customer`, `id_cashier`, `total_diskon`, `diskon_poin`, `grand_total`, `status`, `payment_method`, `due_date`, `purchase_type`, `transaction_type`) VALUES
(7, '12451', '2023-09-26', NULL, 1, 1, 500, 0, 54500, 1, 'CASH', NULL, 'offline', 'OFFLINE'),
(8, 'ORD0035', '2023-09-25', NULL, 3, 1, 500, 0, 62000, 1, 'CASH', NULL, 'offline', 'OFFLINE'),
(9, 'ORD003', '2023-09-25', NULL, 2, 2, 500, 0, 14500, 1, 'CASH', NULL, 'offline', 'OFFLINE'),
(10, 'DEL001', '2023-10-05', NULL, 3, 1, 0, 0, 5100000, 1, 'CASH', NULL, 'offline', 'DELIVERY'),
(11, 'ORD003', '2023-10-04', NULL, 1, 1, 500, 0, 24500, 2, 'CREDIT', '2023-10-12', 'offline', 'OFFLINE'),
(12, 'ORD005', '2023-10-04', NULL, 1, 1, 500, 150, 24350, 1, 'CASH', NULL, 'offline', 'OFFLINE');
...
--
ALTER TABLE `tier_pricing`
  MODIFY `id` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=479;
