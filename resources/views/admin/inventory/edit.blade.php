                        ...
                        <form id="formadd" action="{{URL('admin/master_inventory/do_edit').'/'.$data_inventory->id}}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control required" name="price_buy" placeholder="Price Buy" value="{{$data_inventory->price_buy}}">
                                </div>
                                <div class="form-group">
                                    <label>Price Sell</label>
                                    <input type="number" class="form-control required" name="price_sell" placeholder="Price Sell" value="{{$data_inventory->price_sell}}">
                                </div>
                                <div class="form-group">
