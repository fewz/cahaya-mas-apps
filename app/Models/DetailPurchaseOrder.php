...
class DetailPurchaseOrder extends Model
{
    ...
    public static function terima_barang($id_header, $id_inventory, $id_unit, $date_expired, $qty, $total_pengiriman)
    {
        ...
        LogTerimaBarang::add_log($id_inventory, $id_header, $id_unit, $qty, $date_expired, $total_pengiriman);
    }
}
