...
<script>
    ...
    $(function() {
        const data_produk_supplier = <?php echo $data_produk_supplier; ?>

        console.log('da', data_produk_supplier);
        data_produk_supplier.forEach((val) => {
            listProduk.push(val.id_product + '-' + val.name);
        });
